    ...
    def _compute_single_chunk(self):
        ...
        for p_scan in self.p_scan_values:
            ...
            for _ in range(self.chunk_size):
                ...
                _, singular_values = tripartite_mutual_information_tao(
    ...
    def _compute_comparison_chunk(self):
        ...
        for p_scan in self.p_scan_values:
            ...
            for _ in range(self.chunk_size):
                ...
                for _ in range(self.num_time_steps):
                    qct_tao.step_evolution()
                _, tao_singular_values = tripartite_mutual_information_tao(
                    qct_tao.state, self.L, n=0, return_singular_values=True)
                ...
                _, haining_singular_values = tripartite_mutual_information_tao(
...
class DataManager:
    ...
    def save_chunk(self, result, rank, chunk_idx):
        ...
        chunk_idx : int
            Chunk index
        """
        p_fixed_name = 'pproj' if 'pproj' in result else 'pctrl'
